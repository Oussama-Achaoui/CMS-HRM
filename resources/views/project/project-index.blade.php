                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">{{clean( trans('Action') , array('Attr.EnableID' => true))}}</th>
                        </tr>
                    </thead>
                        ...
                        @if($projects)
                            @foreach($projects as $project)
                                <tr>
                                    ...
                                    <td data-label="Photo"><img height="50" src="{{$project->photo ? '/images/media/' . $project->photo->file : '/public/img/200x200.png'}}" alt=""><p class="mb-0 mt-2"></p></td>
                                    ...
                                    <td class="body-project"><a href="{{ route('project.edit', $project->id) . '?language=' . request()->input('language')}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
