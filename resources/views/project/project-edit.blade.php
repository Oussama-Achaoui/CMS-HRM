					        ...
					        <div class="row">
                                 ...
                                 <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <img class="img-fluid pb-4" width="100" height="100" src="{{$project->photo ? '/images/media/' . $project->photo->file : '/public/img/200x200.png'}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="body" id="hidden-body-field" value="{{ $project->body }}" hidden>
                                                <div id="body-editor">
                                                    {!! $project->body !!}
                                                </div>
                                    </div>
