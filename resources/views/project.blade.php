   		...
   		<div class="container">
			...
			<div class="gallery">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="featured-image">
							<a href="{{$project->photo ? '/images/media/' . $project->photo->file : '/public/img/200x200.png'}}">
								<img class="img-fluid lazy" src="/public/img/loading-blog.gif" data-src="{{$project->photo ? '/images/media/' . $project->photo->file : '/public/img/200x200.png'}}">
							</a>
						</div>
					</div>
				</div>
