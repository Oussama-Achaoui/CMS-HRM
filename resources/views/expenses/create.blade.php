...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">{{ clean(__('niva-backend.create_expense'), ['Attr.EnableID' => true]) }}</h1>

        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ clean(__('niva-backend.create_expense'), ['Attr.EnableID' => true]) }}</h6>
            </div>
            <div class="card-body">
                        ...
                        <form action="{{ route('expenses.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 text-right">
                                    <button type="submit" class="btn btn-primary">{{ clean(__('niva-backend.create_expense'), ['Attr.EnableID' => true]) }}</button>
                                </div>
                            </div>
                        </form>
