...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">{{ clean(trans('niva-backend.create_client'), ['Attr.EnableID' => true]) }}
        </h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    {{ clean(trans('niva-backend.create_client'), ['Attr.EnableID' => true]) }}</h6>
            </div>
            <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="CodeUp_name" class="form-control" placeholder=""
                                            value="{{ old('CodeUp_name') }}">
                                    </div>
                                    <div class="form-group">
                                        <strong>{{ clean(trans('niva-backend.CodeUp_link'), ['Attr.EnableID' => true]) }}</strong>
                                        <input type="text" name="CodeUp_link" class="form-control" placeholder=""
                                            value="{{ old('CodeUp_link') }}">
                                    </div>
